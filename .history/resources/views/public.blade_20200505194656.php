        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="/record">Records</a>
          ...
          <li class="nav-item">
            <a class="nav-link " href="/signin" class="btn btn-link" style="text-decoration: none; ">Sign-Up</a>
          </li>

          <li class="nav-item">
            <a class="nav-link " href="/login" class="btn btn-link" style="text-decoration: none;">Log-In</a>
          </li>
